-- Route draft metadata for GPS-recorded trails.
...
-- Existing public read policy remains in place. Guides can add GPS draft
-- routes for admin review, but cannot self-promote them to official trails.
...
-- Keep active trail rows consistently marked as official for the app map.
