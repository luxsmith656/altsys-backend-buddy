...
export default function EndHikeSettlementDialog({
  ...
  // Fee Calculations
  const { guideFee, guidesNeeded, entryFee, envFee, totalFee: baseTotalFee } = calculateFees(groupSize, { hikeType: meta.hikeType });
          ...
          <div className="rounded-2xl border border-border/50 bg-secondary/10 p-4 space-y-3">
            ...
            <div className="space-y-1.5 text-xs">
              <div className="flex justify-between text-muted-foreground">
                  <span>Guide Fee ({guidesNeeded} guide{guidesNeeded === 1 ? '' : 's'} · {formatPeso(guidesNeeded ? guideFee / guidesNeeded : 0)} each)</span>
